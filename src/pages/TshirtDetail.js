...
import { getTshirt, gettshirtDetails } from "../Actions/shirtAction";
...
const TshirtDetail = () => {
  ...
  const {loading,error,product} = useSelector(state =>state.tshirtdetail)
